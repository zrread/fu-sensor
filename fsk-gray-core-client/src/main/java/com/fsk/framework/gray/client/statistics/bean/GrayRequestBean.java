package com.fsk.framework.gray.client.statistics.bean;
...
public class GrayRequestBean {
    ...
    public GrayRequestBean(String currentServiceName, String gatewayIp, String serviceName, String serviceIp, AtomicInteger counter, int totalCounter, int servicePort, String requestUrl, long requestMs, String retCode, String isGray) {
